...
public:
	...
	*/
	vector<int> selectPivots(CMetricDistance *metric,vector<std::shared_ptr<CMetricData> > &data,int numPivots);
    ...
    /*
		...
		@return return a container consists of the indexes of the selected pivots in the given data set 
	*/
	vector<int> selectPivots(CMetricDistance *metric,vector<std::shared_ptr<CMetricData> > &data,int first,int dataSize,int numPivots);
	...
	/*
		...
		@return return a container consists of the indexes of the selected pivots in the given data set 
	*/
	vector<int> selectPivots(CMetricDistance *metric,vector<std::shared_ptr<CMetricData> > &data,int first,int dataSize,int numPivots,int firstPivot);
};
