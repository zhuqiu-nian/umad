/*$Id: SpectraWithPrecursorMass.java,v 1.2 2007/07/12 22:50:44 rmao Exp $*/
/**
 * edu.utexas.type.MSData 2003.08.13
 * <p>
 * Copyright Information:
 * <p>
 * Change Log:
 * 2003.08.13: Modified from the original mobios package, by Rui Mao
...
import db.table.SpectraWithPrecursorMassTable;
...
public class SpectraWithPrecursorMass extends Spectra
{
     ...
     * @param rowID 行号
     * @param precursorMass precursorMass
    ...
    {
        if (!(oThat instanceof SpectraWithPrecursorMass)) throw new Error("not compatible");
    ...
    {
        if (!(that instanceof SpectraWithPrecursorMass)) return false;
        else
        {
